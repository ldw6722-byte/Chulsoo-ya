...
export function CheckoutPage() {
  ...
  function selectKakaoAddress(selected: KakaoPostcodeAddress) {
    const selectedAddress = selected.roadAddress || selected.address
    setAddress(selectedAddress); setAddressDetail(''); setRegion(null); setSelectedDeliveryAddressId(null); void resolveRegion(selectedAddress)
  }
  ...
  async function submit() {
    if (cart.data?.items.some((item) => !item.active)) { setError('재고 없는 상품이 있습니다. 장바구니에서 삭제한 뒤 다시 주문해 주세요.'); return }
