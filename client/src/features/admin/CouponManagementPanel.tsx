...
export function CouponManagementPanel() {
  ...
  const create = async () => {
    if (!code.trim() || !title.trim()) { setNotice('쿠폰 코드와 제목을 입력해 주세요.'); return }
