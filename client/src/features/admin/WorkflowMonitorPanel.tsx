...
export function WorkflowMonitorPanel() {
  ...
  const forceSlots = async () => {
    ...
    try {
      ...
      notify('판매자 슬롯 설정을 반영했습니다.')
    } catch (error) {
      notify(error instanceof Error ? error.message : '슬롯 설정 변경에 실패했습니다.', 'error')
