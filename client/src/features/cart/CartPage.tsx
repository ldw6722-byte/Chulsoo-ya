...
export function CartPage() {
  ...
  if (cart.loading) return <div className="mx-auto max-w-7xl px-4 py-16"><LoadingView label="장바구니를 불러오는 중입니다" /></div>
